...
print('
  ...
  <div class="PASTELcontainer">
    ...
    <div class="" style="position:relative;">
      <img id="slides_view" src="'.$url_diapo.sprintf("%'.03d\n", $nbDiapo).'.jpg" class="diapositive" style="position:relative;">
      <a href="" style="position: absolute;top:20px;right:20px;"><img src="collapse2.svg" ></a>
    </div>
