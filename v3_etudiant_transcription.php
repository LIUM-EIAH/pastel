...
$PAGE->set_url('/mod/pastel/v3_etudiant_transcription.php', array('id' => $cm->id));
  ...
  <div class="PASTELcontainer">
    ...
    <div class="divGauche">
      ...
      <form id="open_question_form" style="margin-top:5px; margin-bottom:5px;">
        <input type="text" name="question_ouverte" id="open_question_field" placeholder="Entrez votre question/besoin" style="width:100%;">
      </form>

      <div class="scrollRessourcesQuestions">
        <div style="right:25px;top:-4px;color:lightGray;font-weight: bold;z-index=-1;">QUESTIONS DE L\'AUDIENCE</div>
        <div class="scrollRessourcesInside">
          <button class="like" onclick="like(this,0)">👍</button><button class="like" onclick="dislike(this,0)">👎</button><a class="nom_ressource" target="_blank" href="https://fr.wikipedia.org/wiki/Traduction_automatique#Le_processus_de_traduction" style="font-weight: bold;margin-left:10px" onclick="notifierAlerte("ressource","lien",1,"")>Ressource 1</a><br />
            <p class="description_ressource">Texte associé à la ressource 1</p>
          <button class="like" onclick="like(this,0)">👍</button><button class="like" onclick="dislike(this,0)">👎</button><a class="nom_ressource" target="_blank" href="https://fr.wikipedia.org/wiki/Traduction_automatique#Le_processus_de_traduction" style="font-weight: bold;margin-left:10px" onclick="notifierAlerte("ressource","lien",1,"")>Ressource 2</a><br />
            <p class="description_ressource">Texte associé à la ressource 2</p>
            <button class="like" onclick="like(this,0)">👍</button><button class="like" onclick="dislike(this,0)">👎</button><a class="nom_ressource" target="_blank" href="https://fr.wikipedia.org/wiki/Traduction_automatique#Le_processus_de_traduction" style="font-weight: bold;margin-left:10px" onclick="notifierAlerte("ressource","lien",1,"")>Ressource 1</a><br />
            <p class="description_ressource">Texte associé à la ressource 1</p>
          <button class="like" onclick="like(this,0)">👍</button><button class="like" onclick="dislike(this,0)">👎</button><a class="nom_ressource" target="_blank" href="https://fr.wikipedia.org/wiki/Traduction_automatique#Le_processus_de_traduction" style="font-weight: bold;margin-left:10px" onclick="notifierAlerte("ressource","lien",1,"")>Ressource 2</a><br />
            <p class="description_ressource">Texte associé à la ressource 2</p>
      ...
      <div class="scrollRessourcesCommun">
        ...
        <div class="scrollRessourcesInside">
          <button class="like" onclick="like(this,0)">👍</button><button class="like" onclick="dislike(this,0)">👎</button><a class="nom_ressource" target="_blank" href="https://fr.wikipedia.org/wiki/Traduction_automatique#Le_processus_de_traduction" style="font-weight: bold;margin-left:10px" onclick="notifierAlerte("ressource","lien",1,"")>Ressource A</a><br />
            <p class="description_ressource">Texte associé à la ressource A</p>
            <button class="like" onclick="like(this,0)">👍</button><button class="like" onclick="dislike(this,0)">👎</button><a class="nom_ressource" target="_blank" href="https://fr.wikipedia.org/wiki/Traduction_automatique#Le_processus_de_traduction" style="font-weight: bold;margin-left:10px" onclick="notifierAlerte("ressource","lien",1,"")>Ressource B</a><br />
            <p class="description_ressource">Texte associé à la ressource B</p>
        </div>
      </div>
    </div>

    <div class="divCentre flexVertical">
      <button class="buttonDiapo" onclick="cacherDiapo()">▲</button>
      <button style="display:none" class="expandDiapo" onclick="afficherDiapo()">▼</button>
      <img id="slides_view" src="'.$url_diapo.sprintf("%'.03d\n", $nbDiapo).'.jpg" class="diapositiveReduite">
      <div class="transcription">
        <div class="transcriptWrapper">
          <div class="blocTranscript">
          DIAPO 1 : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque justo quam, mollis nec enim et, placerat eleifend purus. Fusce in magna a arcu hendrerit fermentum quis sit amet dolor. Duis egestas fringilla consequat. In rhoncus libero consequat nibh tempor, non dignissim velit pretium. Duis luctus blandit felis auctor interdum. Nunc vel posuere urna. Vivamus id urna ligula. Suspendisse potenti. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla sit amet consectetur nunc, non aliquet risus.
          </div>
        </div>
        <div class="transcriptWrapper">
          <div class="blocTranscript">
          DIAPO 2 : Sed vulputate viverra odio nec aliquet. Nulla congue magna at magna volutpat tincidunt. Cras neque urna, interdum eu vulputate id, hendrerit sed neque. Nulla ac nunc tempus, interdum leo et, ornare leo. Sed nec eros elit. Aliquam a mollis ex. Morbi id eleifend risus.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque justo quam, mollis nec enim et, placerat eleifend purus. Fusce in magna a arcu hendrerit fermentum quis sit amet dolor. Duis egestas fringilla consequat. In rhoncus libero consequat nibh tempor, non dignissim velit pretium. Duis luctus blandit felis auctor interdum. Nunc vel posuere urna. Vivamus id urna ligula. Suspendisse potenti. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla sit amet consectetur nunc, non aliquet risus.
          </div>
        </div>
        <div class="transcriptWrapper">
          <div class="blocTranscript">
        ...
        <div class="transcriptWrapper">
          <div class="blocTranscript">
          DIAPO 4 : Sed vulputate viverra odio nec aliquet. Nulla congue magna at magna volutpat tincidunt. Cras neque urna, interdum eu vulputate id, hendrerit sed neque. Nulla ac nunc tempus, interdum leo et, ornare leo. Sed nec eros elit. Aliquam a mollis ex. Morbi id eleifend risus.
          </div>
        </div>
      </div>
    </div>
...
foreach ($notesImportees as $item){
  ...
  function gestionPopup (element){  // A AJOUTER EN HAUT
